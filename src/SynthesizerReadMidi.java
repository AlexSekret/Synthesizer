...
//// * TODO - считывать ноты из текстового файла и проигрывать;
//// * TODO - воспроизводить MIDI-файлы (в гугле легко находятся MIDI-файлы и код как их воспроизводить с помощью джавы)
//// */
////
////    public static void play (String[] args) throws MidiUnavailableException, InvalidMidiDataException, InterruptedException, IOException {
////        /*
...
//////            System.exit(-1);
//////        }
////        //Path file = Paths.get("D:\\Programming\\Java\\project1\\synthesizer\\src\\notes.txt");
...
////
//////        String text = scanner.nextLine().toUpperCase().trim();
//////        String[] noteSequence = text.toUpperCase().split(" ");
////        String text = SynthesizerReadMidi.readNotesFromFile(arg[0]);
////        String[] noteSequence = text.toUpperCase().split(" ");
...
////            textSequence = textSequence + line;
////        }
////        return textSequence;
//    }
//}