...
public class SynthesizerConsoleSequence {
    ...
    public static void play() throws MidiUnavailableException, InvalidMidiDataException, InterruptedException, IOException {
        /*
